...
chapt4_interfaces__srv__FaceDetect_Request__init(chapt4_interfaces__srv__FaceDetect_Request * msg)
{
  ...
  if (!sensor_msgs__msg__Image__init(&msg->image)) {
    chapt4_interfaces__srv__FaceDetect_Request__fini(msg);
    return false;
  }
  return true;
}
...
chapt4_interfaces__srv__FaceDetect_Request__create()
{
  ...
  chapt4_interfaces__srv__FaceDetect_Request * msg = (chapt4_interfaces__srv__FaceDetect_Request *)allocator.allocate(sizeof(chapt4_interfaces__srv__FaceDetect_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chapt4_interfaces__srv__FaceDetect_Request));
  bool success = chapt4_interfaces__srv__FaceDetect_Request__init(msg);
  if (!success) {
...
chapt4_interfaces__srv__FaceDetect_Request__Sequence__init(chapt4_interfaces__srv__FaceDetect_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chapt4_interfaces__srv__FaceDetect_Request * data = NULL;

  if (size) {
    data = (chapt4_interfaces__srv__FaceDetect_Request *)allocator.zero_allocate(size, sizeof(chapt4_interfaces__srv__FaceDetect_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chapt4_interfaces__srv__FaceDetect_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        chapt4_interfaces__srv__FaceDetect_Request__fini(&data[i - 1]);
      }
...
chapt4_interfaces__srv__FaceDetect_Request__Sequence__fini(chapt4_interfaces__srv__FaceDetect_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      chapt4_interfaces__srv__FaceDetect_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chapt4_interfaces__srv__FaceDetect_Request__Sequence * array = (chapt4_interfaces__srv__FaceDetect_Request__Sequence *)allocator.allocate(sizeof(chapt4_interfaces__srv__FaceDetect_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = chapt4_interfaces__srv__FaceDetect_Request__Sequence__init(array, size);
  if (!success) {
...
chapt4_interfaces__srv__FaceDetect_Request__Sequence__destroy(chapt4_interfaces__srv__FaceDetect_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    chapt4_interfaces__srv__FaceDetect_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
chapt4_interfaces__srv__FaceDetect_Request__Sequence__are_equal(const chapt4_interfaces__srv__FaceDetect_Request__Sequence * lhs, const chapt4_interfaces__srv__FaceDetect_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!chapt4_interfaces__srv__FaceDetect_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  chapt4_interfaces__srv__FaceDetect_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(chapt4_interfaces__srv__FaceDetect_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    chapt4_interfaces__srv__FaceDetect_Request * data =
      (chapt4_interfaces__srv__FaceDetect_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!chapt4_interfaces__srv__FaceDetect_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          chapt4_interfaces__srv__FaceDetect_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!chapt4_interfaces__srv__FaceDetect_Request__copy(
...
chapt4_interfaces__srv__FaceDetect_Response__init(chapt4_interfaces__srv__FaceDetect_Response * msg)
{
  ...
  if (!rosidl_runtime_c__int32__Sequence__init(&msg->top, 0)) {
    chapt4_interfaces__srv__FaceDetect_Response__fini(msg);
    return false;
  }
  // right
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chapt4_interfaces__srv__FaceDetect_Response * msg = (chapt4_interfaces__srv__FaceDetect_Response *)allocator.allocate(sizeof(chapt4_interfaces__srv__FaceDetect_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(chapt4_interfaces__srv__FaceDetect_Response));
  bool success = chapt4_interfaces__srv__FaceDetect_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
chapt4_interfaces__srv__FaceDetect_Response__Sequence__init(chapt4_interfaces__srv__FaceDetect_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chapt4_interfaces__srv__FaceDetect_Response * data = NULL;

  if (size) {
    data = (chapt4_interfaces__srv__FaceDetect_Response *)allocator.zero_allocate(size, sizeof(chapt4_interfaces__srv__FaceDetect_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = chapt4_interfaces__srv__FaceDetect_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        chapt4_interfaces__srv__FaceDetect_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
chapt4_interfaces__srv__FaceDetect_Response__Sequence__fini(chapt4_interfaces__srv__FaceDetect_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      chapt4_interfaces__srv__FaceDetect_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  chapt4_interfaces__srv__FaceDetect_Response__Sequence * array = (chapt4_interfaces__srv__FaceDetect_Response__Sequence *)allocator.allocate(sizeof(chapt4_interfaces__srv__FaceDetect_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = chapt4_interfaces__srv__FaceDetect_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
chapt4_interfaces__srv__FaceDetect_Response__Sequence__destroy(chapt4_interfaces__srv__FaceDetect_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    chapt4_interfaces__srv__FaceDetect_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
chapt4_interfaces__srv__FaceDetect_Response__Sequence__are_equal(const chapt4_interfaces__srv__FaceDetect_Response__Sequence * lhs, const chapt4_interfaces__srv__FaceDetect_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!chapt4_interfaces__srv__FaceDetect_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  chapt4_interfaces__srv__FaceDetect_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(chapt4_interfaces__srv__FaceDetect_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    chapt4_interfaces__srv__FaceDetect_Response * data =
      (chapt4_interfaces__srv__FaceDetect_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!chapt4_interfaces__srv__FaceDetect_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          chapt4_interfaces__srv__FaceDetect_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!chapt4_interfaces__srv__FaceDetect_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
